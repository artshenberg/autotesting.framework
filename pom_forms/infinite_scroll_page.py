...
class InfiniteScrollPage(BaseForm):
    ...
    # Elements:
    JSCROLL_ADDED_ELEMENT = Paragraph((By.CLASS_NAME, 'jscroll-added'), 'JSCROLL_ADDED_ELEMENT')
    ...
    def do_infinite_scroll(self, iterations):
        Engine.infinite_scrolling(self.JSCROLL_ADDED_ELEMENT, iterations)

    def should_be_same_number(self, age):
        return len(self.JSCROLL_ADDED_ELEMENT.wait_for_elements()) == int(age)
